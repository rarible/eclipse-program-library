...
describe('Editions Controls Test Suite', () => {
  ...
  describe('Adding phases', () => {
    ...
    it.skip('Should add a public phase with allowlist. [Phase Index 1]: Open: O.1 SOL, Allowlist: 0.05 SOL', async () => {
      phase1Config = {
  ...
  describe('Minting', () => {
    ...
    // mints 1 + 1 + 3 + 5 = 10 total
    describe.skip('Minting on a public phase with optional allowlist [Phase Index 1]', () => {
